...
def run_backtest(df, start_date, initial_capital, commission_pct, top_n=10):
    """
    ...
    momentum_score = ret_3m + 2*ret_6m
...
def main():
    ...
    if st.sidebar.button("🚀 Kör Backtest"):
        ...
        with st.spinner("Simulerar..."):
            ...
            res, latest_picks = run_backtest(df, str(start_date), initial_capital, commission_pct, top_n=top_n)
